...
function getViewportCenter() {
  if (typeof window !== "undefined") {
    ...
    const viewportHeight = (window as any).innerHeight;
    ...
    console.warn(
      "Cannot access window object. Running in a non-browser environment.",
    );
    return { x: 0, y: 0 };
  }
}
...
>(({ className, children, ...props }, ref) => {
  const [center, setCenter] = React.useState(getViewportCenter());
